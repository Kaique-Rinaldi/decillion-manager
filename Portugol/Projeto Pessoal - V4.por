programa
{
	...
	funcao inicio()
	{
		...
		cadeia statusPagamento[1000], statusProjeto[1000]
		inteiro pagamentoStatus, opcaostatusProjeto
		inteiro datainicioProjeto[1000], datafinalProjeto[1000]
		real totalReceber
	...
	///ENTRADA DE DADOS
		...
		se(opcao == 2){
			...
			escreva("\nData de Início do Projeto: ", datainicioProjeto[i])	
			escreva("\nData Prevista para Término do Projeto: ", datafinalProjeto[i])
